document.addEventListener('DOMContentLoaded', function() {
    ...
    function startWorkTimer() {
        ...
        timerDisplay.style.animation = "borderAnimationStart 2s ease-in-out forwards";
    ...
    startButton.addEventListener('click', function() {
        if (totalSecondes === null) {
            ...
            timerDisplay.style.animation = "borderAnimationEnd 2s ease-in-out forwards";
        }
    });

    // affichage du menu de configuration 
    showButton.addEventListener('click', function() {
        configuration.style.display = (configuration.style.display === "none") ? "flex" : "none";
        titleDisplay.style.display = (titleDisplay.style.display === "none") ? "flex" : "none";
        timerDisplay.style.display = (timerDisplay.style.display === "none") ? "flex" : "none";
